...
│ JobSpy  │   │  Haiku  │   │ Opus4.5 │   │Comp.Use │
└─────────┘   └─────────┘   └─────────┘   └─────────┘

Tech Stack:
- Python (JobSpy for scraping, proxy rotation)
- n8n workflow automation (self-hosted on Hetzner VPS)
- Claude AI: Haiku for job scoring, Opus 4.5 for document generation
...
- Building autonomous job application system using:
  - Claude API (Haiku for scoring, Opus for document generation)
...
# Use full profile for scoring too (Haiku can handle it)
